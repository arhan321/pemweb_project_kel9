        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.orderditempats.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nama_pemesan') ? 'is-invalid' : '' }}" type="text"
                        name="nama_pemesan" id="nama_pemesan" value="{{ old('nama_pemesan', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('tanggal_pesan') ? 'is-invalid' : '' }}" type="date"
                ...
                <div class="form-group">
                    <label for="table">{{ trans('cruds.orderditempat.fields.table') }}</label>
                    <select class="form-control {{ $errors->has('table') ? 'is-invalid' : '' }}" name="table_id"
                        id="table">
                        @foreach ($tables as $table)
                            <option value="{{ $table->id }}" {{ old('table_id') == $table->id ? 'selected' : '' }}
                                {{ $table->status == 'terbooking' ? 'disabled' : '' }}>
                ...
                <div class="form-group">
                    <label class="required">{{ trans('cruds.orderditempat.fields.status_bayar') }}</label>
                    <select class="form-control {{ $errors->has('status_bayar') ? 'is-invalid' : '' }}" name="status_bayar"
                        ...
                        @foreach (App\Models\Orderditempat::STATUS_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('status_bayar', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                            </option>
                        @endforeach
                    </select>

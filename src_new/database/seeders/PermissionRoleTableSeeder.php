...
class PermissionRoleTableSeeder extends Seeder
{
    public function run()
    {
         ...
         $kasir_permissions = Permission::whereBetween('id', [74, 104])
         ...
         $waiter_permissions = Permission::whereBetween('id', [74, 104])
        //  ->orWhereBetween('id', [51, 80])
         ->get();
          ...
          $kepalachef_permissions = Permission::whereBetween('id', [74, 104])
         ...
         ->get();
          ...
          $bartender_permissions = Permission::whereBetween('id', [74, 104])
          //  ->orWhereBetween('id', [51, 80])
          ->get();

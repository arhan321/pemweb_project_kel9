...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.signatures.store") }}" enctype="multipart/form-data">
            ...
            {{-- <div class="form-group">
                <label for="menu_name">{{ trans('cruds.signature.fields.name') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.signature.fields.name_helper') }}</span>
            </div> --}}
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.signatures.storeCKEditorImages') }}', true);
                ...
                data.append('crud_id', '{{ $signature->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.footers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('logo_restoran') ? 'is-invalid' : '' }}" type="text" name="logo_restoran" id="logo_restoran" value="{{ old('logo_restoran', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opening_day') ? 'is-invalid' : '' }}" type="text" name="opening_day" id="opening_day" value="{{ old('opening_day', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opening_hours') ? 'is-invalid' : '' }}" type="time" name="opening_hours" id="opening_hours" value="{{ old('opening_hours', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('closing_hours') ? 'is-invalid' : '' }}" type="time" name="closing_hours" id="closing_hours" value="{{ old('closing_hours', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desain_by') ? 'is-invalid' : '' }}" type="text" name="desain_by" id="desain_by" value="{{ old('desain_by', '') }}">
                @if($errors->has('desain_by'))
                    <div class="invalid-feedback">
                        {{ $errors->first('desain_by') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.footer.fields.desain_by_helper') }}</span>
            </div>
            <div class="form-group">

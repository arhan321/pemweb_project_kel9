...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tables.update", [$table->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="status">{{ trans('cruds.table.fields.status') }}</label>
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    <option value="" disabled {{ old('status', $table->status) === null ? 'selected' : '' }}>Please select</option>
                    <option value="kosong" {{ old('status', $table->status) === 'kosong' ? 'selected' : '' }}>kosong</option>
                    <option value="terbooking" {{ old('status', $table->status) === 'terbooking' ? 'selected' : '' }}>terbooking</option>
                </select>

...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover datatable datatable-bookingmanual">
                <thead>
                    <tr>
                        <th width="10">
...
<script>
    $(function () {
        ...
        let table = $('.datatable-bookingmanual:not(.ajaxTable)').DataTable({ buttons: dtButtons })

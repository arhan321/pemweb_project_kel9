    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.homes.update", [$home->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.home.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $home->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                <label class="required" for="image">{{ trans('cruds.home.fields.image') }}</label>
